...
public class DataProcessing extends ArrayList<StepCounterInstance> implements Parcelable {
    ...
    private String STEP_COUNTER_DATA_FILENAME = Environment.getExternalStorageDirectory() + "/" + "StepCounterData.txt";
    private String User_DATA_FILENAME = Environment.getExternalStorageDirectory() + "/" + "UserData.txt";
